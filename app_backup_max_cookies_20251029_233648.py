...
# =============================================================================
# 🍪 CONFIGURAÇÕES OTIMIZADAS PARA 100 QUESTÕES
# =============================================================================
app.config.update(
    SESSION_COOKIE_MAX_SIZE=32768,  # 32KB para suportar 100 questões
    MAX_COOKIE_SIZE=32768,
...
# =============================================================================
app.config.update(
    SESSION_COOKIE_MAX_SIZE=32768,  # 16KB
    MAX_COOKIE_SIZE=32768,
    SESSION_COOKIE_HTTPONLY=True,
    SESSION_COOKIE_SECURE=False,
    SESSION_COOKIE_SAMESITE='Lax',
...
def iniciar_simulado():
    try:
        ...
        limite_maximo = 100  # Máximo de questões por sessão (aumentado de 30 para 100)  # Máximo de questões por sessão para evitar cookie grande
        
        if quantidade_str == "295": # Flag para "Todas as Questões" (até 100)
